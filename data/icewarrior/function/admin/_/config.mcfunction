...
#upper text
tellraw @s [{"color":"#9FC0FA","text":"❄"},{"bold":true,"color":"aqua","text":" The Ice Warrior "},{"bold":false,"color":"#9FC0FA","text":"❄"},{"bold":false,"color":"dark_gray","text":" beta2-3 mc1.21.1"},{"bold":false,"color":"aqua","text":" config:"}]
tellraw @s [{"text":" "}]
...
tellraw @s [{"color":"gray","text":" - master max combo: "},{"clickEvent":{"action":"suggest_command","value":"/function icewarrior:admin/config/phase3_combo {value:INSERT_VALUE_HERE}"},"color":"#3061FF","score":{"name":"#icew.config","objective":"icew.config.phase3_combo"}}]
tellraw @s [{"text":" "}]
