...
#high_slash
execute if score @s icew.attCooldown matches -20..0 run execute positioned ~ ~-1.5 ~ positioned ^ ^ ^0.8 run execute if entity @e[tag=icew.target,distance=..1.75,limit=1] run execute if predicate icewarrior:random_25 run function icewarrior:boss/execute_attack_p0 {ID:3}

#foward_slash
execute if score @s icew.attCooldown matches -20..0 run execute positioned ~ ~-1.5 ~ positioned ^ ^ ^1.5 run execute if entity @e[tag=icew.target,distance=..1.75,limit=1] run execute if predicate icewarrior:random_30 run function icewarrior:boss/execute_attack_p0 {ID:5}

#long_claw
execute if score @s icew.attCooldown matches -20..0 run execute positioned ~ ~-0.75 ~ if block ^ ^ ^1 #minecraft:air positioned ^ ^ ^5 run execute if entity @e[tag=icew.target,distance=..1.5,limit=1] run execute if predicate icewarrior:random_8 run function icewarrior:boss/execute_attack_p0 {ID:4}
execute if score @s icew.attCooldown matches -20..0 run execute positioned ~ ~-0.75 ~ if block ^ ^ ^1 #minecraft:air positioned ^ ^ ^6 run execute if entity @e[tag=icew.target,distance=..1.5,limit=1] run execute if predicate icewarrior:random_15 run function icewarrior:boss/execute_attack_p0 {ID:4}
execute if score @s icew.attCooldown matches -20..0 run execute positioned ~ ~-0.75 ~ if block ^ ^ ^1 #minecraft:air positioned ^ ^ ^7 run execute if entity @e[tag=icew.target,distance=..1.5,limit=1] run execute if predicate icewarrior:random_15 run function icewarrior:boss/execute_attack_p0 {ID:4}
