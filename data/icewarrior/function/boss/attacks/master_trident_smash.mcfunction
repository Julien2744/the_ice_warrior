...
execute positioned ~ ~-1.5 ~ positioned ^ ^ ^2.5 run launch @n[type=!#icewarrior:non_living,type=!player,tag=!icew.immune,distance=..2.5] addMotion 0 0.5 0
execute positioned ~ ~-1.5 ~ positioned ^ ^ ^2.5 run launch @a[gamemode=!creative,gamemode=!spectator,tag=!icew.immune,distance=..2.5] addMotion 0 0.5 0
