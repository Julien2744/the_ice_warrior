...
execute on vehicle positioned ~ ~-2 ~ run execute if function icewarrior:boss/attacks/damage/trident_slash run execute on passengers run scoreboard players add @s icew.combo 1
