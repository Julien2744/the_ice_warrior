...
return run execute at @e[type=!#icewarrior:non_living,tag=!icew.immune,distance=..2] run damage @n[type=!#icewarrior:non_living,tag=!icew.immune,distance=..0.5] 22.5 icewarrior:ice_warrior_attack by @s