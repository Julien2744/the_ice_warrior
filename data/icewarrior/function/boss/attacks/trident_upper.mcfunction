...
execute on vehicle positioned ~ ~-1.5 ~ positioned ^ ^ ^1.5 run execute if function icewarrior:boss/attacks/damage/trident_upper run execute on passengers run scoreboard players add @s icew.combo 1
