...
execute if score @s icew.phase matches 0 facing entity @n[tag=icew.target,distance=..128] eyes run launch @n[type=#icewarrior:can_parry,distance=..2.5,tag=icew.parry,nbt=!{inGround:1b}] looking 2.25
execute if score @s icew.phase matches 3 facing entity @n[tag=icew.target,distance=..128] eyes run launch @n[type=#icewarrior:can_parry,distance=..2.5,tag=icew.parry,nbt=!{inGround:1b}] looking 2.75