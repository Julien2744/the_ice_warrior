...
execute if entity @s[tag=icew.launchToTarget] positioned ~ ~-2 ~ if entity @n[tag=icew.target,distance=..1.75] run function icewarrior:boss/execute_attack_p3 {ID:6}
