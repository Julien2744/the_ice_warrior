...
execute if entity @s[tag=icew.launchToTarget] positioned ^ ^ ^0.5 positioned ~ ~-2 ~ if entity @n[tag=icew.target,distance=..2] run function icewarrior:boss/execute_attack_p3 {ID:6}
