...
#phase 3 (master)
execute if score @s icew.attCooldown matches -20..0 if score @s icew.phase matches 3 if entity @n[tag=icew.target,distance=..42] if entity @s[tag=!icew.launchToTarget,tag=!icew.iceclaw] run execute positioned ~ ~-1.5 ~ run function icewarrior:boss/can_attack_p3
execute if score @s icew.attCooldown matches -20..0 if score @s icew.phase matches 3 if entity @n[tag=icew.target,distance=..42] if entity @s[tag=!icew.launchToTarget,tag=icew.iceclaw] run execute positioned ~ ~-1.5 ~ run function icewarrior:boss/can_attack_p3_claw
