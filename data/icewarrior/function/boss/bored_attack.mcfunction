...
#master_will_parry
execute if score @s[tag=!icew.will_parry] icew.attCooldown matches -20 if score @s icew.phase matches 3 if entity @s[tag=!icew.will_parry,tag=!icew.master_parry] if entity @n[tag=icew.target,distance=..128] run execute if predicate icewarrior:random_35 run function icewarrior:boss/effects/will_parry_indicator

#master_upper_dash
execute if score @s[tag=!icew.will_parry] icew.attCooldown matches -20 if score @s icew.phase matches 3 if entity @n[tag=icew.target,distance=..32] if predicate icewarrior:random_35 run function icewarrior:boss/execute_attack_p3 {ID:5}

#master_trident_crit
execute if score @s[tag=!icew.will_parry] icew.attCooldown matches -20 if score @s icew.phase matches 3 if entity @n[tag=icew.target,distance=..32] if predicate icewarrior:random_50 run function icewarrior:boss/execute_attack_p3 {ID:7}
