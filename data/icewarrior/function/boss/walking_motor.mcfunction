...
execute store result score @s icew.motion.x run execute on vehicle run data get entity @s Motion[0] 100
execute store result score @s icew.motion.z run execute on vehicle run data get entity @s Motion[2] 100
