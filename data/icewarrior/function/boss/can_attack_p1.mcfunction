...
#long_claw
execute if score @s icew.attCooldown matches 0 run execute positioned ~ ~-0.75 ~ positioned ^ ^ ^5 run execute if entity @n[tag=icew.target,distance=..1.5] run execute if predicate icewarrior:random_35 run function icewarrior:boss/execute_attack_p1 {ID:4}
execute if score @s icew.attCooldown matches 0 run execute positioned ~ ~-0.75 ~ positioned ^ ^ ^6 run execute if entity @n[tag=icew.target,distance=..1.5] run execute if predicate icewarrior:random_35 run function icewarrior:boss/execute_attack_p1 {ID:4}
execute if score @s icew.attCooldown matches 0 run execute positioned ~ ~-0.75 ~ positioned ^ ^ ^7 run execute if entity @n[tag=icew.target,distance=..1.5] run execute if predicate icewarrior:random_35 run function icewarrior:boss/execute_attack_p1 {ID:4}