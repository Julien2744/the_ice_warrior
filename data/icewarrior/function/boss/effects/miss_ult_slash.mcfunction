execute on vehicle store result score @n[type=item_display,tag=aj.ice_warrior.root,distance=..4] icew.math.mem run attribute @s generic.max_health get 0.075
