...
execute if score #icew.global icew.checkMobLoot matches 1 if score @s icew.phase matches 3 run function icewarrior:cryo_sigil/give
...
execute if score #icew.config icew.config.bossbar matches 1 if score #icew.global icew.spawned matches 0 run bossbar remove icew_bossbar
