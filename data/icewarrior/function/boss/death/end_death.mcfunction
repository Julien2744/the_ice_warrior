...
execute if score #icew.global icew.checkMobLoot matches 1 if score @s icew.phase matches 1 run summon item ~ ~-0.8 ~ {Glowing:1b,Item:{id:"minecraft:player_head",count:1,components:{"minecraft:custom_name":'{"italic":false,"text":"Ice Warrior Head"}',"minecraft:item_name":'{"italic":false,"text":"Ice Warrior Head"}',"minecraft:lore":['{"color":"gray","italic":false,"text":"This head feel cold to the touch."}','{"color":"gray","italic":false,"text":"Strangely, no damage can be seen on the armor,"}','{"color":"gray","italic":false,"text":"as if it was already repaired."}'],"minecraft:rarity":"epic","minecraft:profile":{properties:[{name:"textures",value:"eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvY2E1NDU1ZTQ4ODVkM2IyZjcxZjJiOTY0ZDQzMmNkNDYyMjk4NTE0ODNiMmI0MGI5ODFjZDg4ZjRlZWUyNmU5MSJ9fX0="}]},"minecraft:note_block_sound":"minecraft:block.glass.break"}}}
