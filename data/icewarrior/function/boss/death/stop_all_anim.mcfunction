...
execute if entity @s[tag=aj.ice_warrior.animation.master_entrance_start.playing] run function animated_java:ice_warrior/animations/master_entrance_start/stop
execute if entity @s[tag=aj.ice_warrior.animation.master_entrance_end.playing] run function animated_java:ice_warrior/animations/master_entrance_end/stop
...
execute if entity @s[tag=aj.ice_warrior.animation.master_parry_slash.playing] run function animated_java:ice_warrior/animations/master_parry_slash/stop