...
execute unless entity @s[tag=aj.ice_warrior.animation.walking_forced.playing] if score @s icew.walking matches 1 run function animated_java:ice_warrior/animations/walking_forced/play
execute if entity @s[tag=aj.ice_warrior.animation.walking_forced.playing] if score @s icew.walking matches 0 run function animated_java:ice_warrior/animations/walking_forced/stop