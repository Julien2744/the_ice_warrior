...
#master_parry
execute if entity @s[tag=icew.will_parry] if score @s icew.attCooldown matches -20..0 unless score @s icew.combo matches 999.. run function icewarrior:boss/execute_attack_p3 {ID:4}
