...
execute as @n[type=item_display,tag=aj.ice_warrior_display.root,tag=icew.boss_summoning] at @s run function icewarrior:admin/summon
#execute as @n[type=item_display,tag=aj.ice_warrior_display.root,tag=icew.boss_summoning] at @s run execute as @n[type=item_display,tag=aj.ice_warrior.root,distance=..4] run function
